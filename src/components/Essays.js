...
export const essays = [
    {
        ...
        content: `
            Second entry to my anxiety journals drumroll. It's only fitting that I write about the worst few days of my life ever. Oh to be young and foolish! Thank God for big girl folly! (You can find the first entry here.) <!--p-->
